...
public class CrawlToPlainTxtOnlyMatching extends AbstractCrawl {
	...
	public static void main(String[] args) {
		...
		try {
			...
			final CrawlToPlainTxtOnlyMatching crawl = new CrawlToPlainTxtOnlyMatching(
					args);
			crawl.crawl();
	...
	protected Options getOptions() {
		...
		final Option filenameOption = new Option("k",
				"the keyword to search for in the page  [required]");
