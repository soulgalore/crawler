...
import com.soulgalore.crawler.core.impl.AhrefAndContainsParser;
import com.soulgalore.crawler.core.impl.DefaultCrawler;
import com.soulgalore.crawler.core.impl.HttpClientResponseFetcher;


/**
 * Crawl and look for specific key in the body.
 *
 */
public class CrawlModuleAndMatch extends AbstractPropertiesModule {

	private final String key;
	
	/**
	 * Create crawl that will look for specific key.
	 * @param theKey the key to look for
	 */
	public CrawlModuleAndMatch(String theKey) {
		super();
		key = theKey;
	}
	...
	protected void configure() {
		...
		bind(Parser.class).toInstance(new AhrefAndContainsParser(key));
